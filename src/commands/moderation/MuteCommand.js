...
module.exports = class MuteCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    .setDescription(`Reason for being warned: ${reason}`)
    .setColor("#5708ab")
    .setTimestamp();
    ...
    if (message.member.roles.highest.position <= mentionedMember.roles.highest.position) return message.channel.send('You cannot mute somone the same role or higher than you.');
