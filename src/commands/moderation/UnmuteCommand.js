...
module.exports = class UnmuteCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    if (message.member.roles.highest.position <= mentionedMember.roles.highest.position) return message.channel.send('You cannot unmute somone the same role or higher than you.');
