...
module.exports = class CalculateCommand extends BaseCommand {
  constructor() {
    super('calc', 'information', ['cacluate', 'calculator']);
  }
  ...
  async run(client, message, args) {
    ...
    if (!args[1]) return message.channel.send('You have to state what you wnat to do with this and another numbers. Options +, -, x, /');
